...
module.exports = {
	...
	run: (client, message, args, users, botData) => {
        ...
        description: `**<a:arrow:1148246980351512700>  Nombre d'utilisateurs : \`${users.size == 0 ? "En cours de chargement..." : users.length.toLocaleString('en-US')}\`\n\n<a:arrow:1148246980351512700> Lien d'authentification : [link](${client.config.authlink})\n<a:arrow:1148246980351512700> Lien du bot : [link](${client.config.botlink})\n\n<a:arrow:1148246980351512700> Join en cours :**`,
